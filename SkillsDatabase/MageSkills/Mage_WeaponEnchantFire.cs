...
public sealed class Mage_WeaponEnchantFire : MH_Skill
{
    private static GameObject VFX_Fist;
    private static GameObject VFX;
    private static GameObject VFX_NonRead;

    public Mage_WeaponEnchantFire()
    {
        _definition._InternalName = "Mage_Weaponenchantfire";
        _definition.Name = "$mh_mage_weaponenchantfire";
        _definition.Description = "$mh_mage_weaponenchantfire_desc";
        ...
        _definition.Icon = MagicHeim.asset.LoadAsset<Sprite>("Mage_WeaponEnchantFire_Icon");
        ...
        VFX = MagicHeim.asset.LoadAsset<GameObject>("Mage_WeaponEnchantFire_VFX");
        VFX_NonRead = MagicHeim.asset.LoadAsset<GameObject>("Mage_WeaponEnchantFire_VFX_NonRead");
...
this.InitRequiredItemFinal("MH_Tome_Mistlands", 3);
    ...
    public override void Execute(Func<bool> Cond)
    {
        ...
        data.type = MH_WeaponEnchant.Type.Fire;
    ...
    private static class MockRight
    {
        ...
        private static void Postfix(VisEquipment __instance)
        {
            ...
            {
                if (__instance.m_nview.m_zdo.GetInt("mh_mage_weaponenchantRight") == (int)MH_WeaponEnchant.Type.Fire)
                {
    ...
    public override string BuildDescription()
    {
        ...
        builder.AppendLine($"Bonus Fire Damage: {Math.Round(currentValue, 1)}");
    ...
    public override Color SkillColor => new Color(1f, 0.13f, 0.1f);
}