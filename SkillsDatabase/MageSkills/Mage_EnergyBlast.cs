...
public sealed class Mage_EnergyBlast : MH_Skill
{
    ...
    public class EnergyBlastComponent : MonoBehaviour
    {
        ...
        {
            GameObject explosion = Instantiate(Energyblast_Explosion, transform.position, Quaternion.identity);
    ...
    private IEnumerator Charge(Func<bool> Cond)
    {
        ...
        GameObject go = UnityEngine.Object.Instantiate(Energyblast_Prefab,
    ...
    public override string BuildDescription()
    {
        ...
        if (Level < maxLevel && Level > 0)
        {
            ...
            double roundedAoeDiff = Math.Round(aoeDiff, 1);
