...
public sealed class Mage_WeaponEnchantFrost : MH_Skill
{
    private static GameObject VFX_Fist;
    private static GameObject VFX;
    private static GameObject VFX_NonRead;

    public Mage_WeaponEnchantFrost()
    {
        _definition._InternalName = "Mage_Weaponenchantfrost";
        _definition.Name = "$mh_mage_weaponenchantfrost";
        _definition.Description = "$mh_mage_weaponenchantfrost_desc";
        ...
        _definition.Icon = MagicHeim.asset.LoadAsset<Sprite>("Mage_WeaponEnchantFrost_Icon");
        _definition.Video = "https://kg.sayless.eu/skills/MH_Mage_WeaponFrostEnchant.mp4";
        ...
        VFX = MagicHeim.asset.LoadAsset<GameObject>("Mage_WeaponEnchantFrost_VFX");
    ...
    public override void Execute(Func<bool> Cond)
    {
        ...
        data.type = MH_WeaponEnchant.Type.Frost;
    ...
    private static class MockLeft
    {
        ...
        private static void Postfix(VisEquipment __instance)
        {
            ...
            {
                if (__instance.m_nview.m_zdo.GetInt("mh_mage_weaponenchantLeft") == (int)MH_WeaponEnchant.Type.Frost)
                {
    ...
    private static class MockRight
    {
        ...
        private static void Postfix(VisEquipment __instance)
        {
            ...
            {
                if (__instance.m_nview.m_zdo.GetInt("mh_mage_weaponenchantRight") == (int)MH_WeaponEnchant.Type.Frost)
                {
                    GameObject go = UnityEngine.Object.Instantiate(
    ...
    public override string BuildDescription()
    {
        ...
        builder.AppendLine($"Bonus Frost Damage: {Math.Round(currentValue, 1)}");
