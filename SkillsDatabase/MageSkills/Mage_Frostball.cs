...
public sealed class Mage_Frostball : MH_Skill
{
    ...
    public Mage_Frostball()
    {
        ...
        _definition.Video = "https://kg.sayless.eu/skills/MH_Mage_Frostball.mp4";
    ...
    public class FrostballComponent : MonoBehaviour
    {
        ...
        {
            GameObject explosion = Instantiate(Frostball_Explosion, transform.position, Quaternion.identity);
    ...
    public override void Execute(Func<bool> Cond)
    {
        ...
        GameObject go = UnityEngine.Object.Instantiate(Frostball_Prefab,
